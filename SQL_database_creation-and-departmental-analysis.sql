...
);                                    -- After creating all the table than you only you can assign foregin key
...
-- Foreign key will store the entry of primary key in different table

/*Data for the table countries */
CREATE TABLE countries(
country_id  varchar(8000),  -- uniq means Duplicate value not allowed
country_name Text,
region_id int
);
...
location_id int, 
street_address Text, 
postal_code varchar(255) DEFAULT 'NOT Given', -- If value is Null it will write NOT given instead
city TEXT, 
state_province TEXT, 
country_id text,
...
ON DELETE SET NULL;  -- FOR DELETE OPERATION	

ALTER TABLE departments
ADD FOREIGN KEY(location_id) 
REFERENCES locations(location_id) 
ON DELETE SET NULL;  -- FOR DELETE OPERATION
-- IF location is deleted It will automatically set 
...
ON DELETE SET NULL;  -- FOR DELETE OPERATIONx`/*Data for the table regions */
